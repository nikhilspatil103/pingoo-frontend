...
export default function HomeScreen({ navigation }) {
  ...
  const profiles = [
    { id: 1, name: 'Anastasia', age: 30, gender: 'female', tag: 'Communication', image: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=400', borderColor: ['#FF6B9D', '#C471ED'] },
    { id: 2, name: 'Liza', age: 24, gender: 'female', tag: 'Communication', image: null, borderColor: ['#4ECDC4', '#556270'] },
    { id: 3, name: 'Eva', age: 22, gender: 'female', tag: 'Friendship', image: 'https://images.unsplash.com/photo-1524504388940-b1c1722653e1?w=400', borderColor: ['#FFB6C1', '#FFA07A'] },
    { id: 4, name: 'Lana', age: 28, gender: 'female', tag: 'Language Practice', image: null, borderColor: ['#E0BBE4', '#957DAD'] },
    { id: 5, name: 'Sofia', age: 26, gender: 'female', tag: 'Travel Buddy', image: 'https://images.unsplash.com/photo-1529626455594-4ff0802cfb7e?w=400', borderColor: ['#FF6B9D', '#C471ED'] },
    { id: 6, name: 'Maria', age: 29, gender: 'female', tag: 'Coffee Dates', image: null, borderColor: ['#4ECDC4', '#556270'] },
    { id: 7, name: 'Alex', age: 27, gender: 'male', tag: 'Sports', image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=400', borderColor: ['#FFB6C1', '#FFA07A'] },
    { id: 8, name: 'David', age: 31, gender: 'male', tag: 'Music Lover', image: null, borderColor: ['#E0BBE4', '#957DAD'] },
    { id: 9, name: 'Nina', age: 25, gender: 'female', tag: 'Art & Culture', image: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=400', borderColor: ['#FF6B9D', '#C471ED'] },
    { id: 10, name: 'Kate', age: 23, gender: 'female', tag: 'Foodie', image: null, borderColor: ['#4ECDC4', '#556270'] },
  ];
...
const getStyles = (theme, isDark) => StyleSheet.create({
  ...
  listCard: { width: '100%', backgroundColor: isDark ? '#1a1a1a' : '#fff', borderRadius: 16, overflow: 'hidden' },
