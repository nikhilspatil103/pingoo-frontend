...
const getStyles = (theme, isDark) => StyleSheet.create({
  ...
  infoCard: { borderRadius: 20, padding: 18, marginBottom: 10, backgroundColor: isDark ? '#2a2440' : '#ffffff', elevation: 2, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.1, shadowRadius: 3 },
