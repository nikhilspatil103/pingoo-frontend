...
const getStyles = (theme, isDark) => StyleSheet.create({
  ...
  infoCard: { borderRadius: 20, marginBottom: 10, overflow: 'hidden', backgroundColor: isDark ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)', elevation: 2, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.1, shadowRadius: 3 },
  infoCardInner: { flexDirection: 'row', alignItems: 'center', padding: 18 },
